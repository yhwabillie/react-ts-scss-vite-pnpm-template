  ...
  render: args => {
    ...
    return (
      <div style={{ display: 'inline-flex', gap: '20px' }}>
        <Button variant='outline' color='primary' shape={args.shape} size={args.size}>
          {t('hello')}
        </Button>
        <Button variant='outline' color='primary' shape={args.shape} size={args.size} disabled>
          {t('hello')}
        </Button>
      </div>
    );
  ...
  render: args => {
    ...
    return (
      <div style={{ display: 'inline-flex', gap: '10px', alignItems: 'center' }}>
        <Button variant='outline' color='primary' shape={args.shape} size='xl'>
          {t('hello')}
        </Button>
        <Button variant='outline' color='primary' shape={args.shape} size='lg'>
          {t('hello')}
        </Button>
        <Button variant='outline' color='primary' shape={args.shape} size='md'>
          {t('hello')}
        </Button>
        <Button variant='outline' color='primary' shape={args.shape} size='sm'>
          {t('hello')}
        </Button>
        <Button variant='outline' color='primary' shape={args.shape} size='xs'>
          {t('hello')}
        </Button>
      </div>
    );
